...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    function uniswapV2Call(
        ...
        console.log("Collateral WBTC: ", WBTC.balanceOf(address(this)));
        ...
        uint256 wallet_WBTC = WBTC.balanceOf(address(this));
        WBTC.transfer(address(uniswapV2Pair_WBTC_WETH), wallet_WBTC);
